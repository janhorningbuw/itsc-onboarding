const taskTemplate = [
  ...
  ['accounts','month','Set up accounts and software','Email, calendar, Git, Moodle, Zulip and Zotero where needed.',18], ['photo','month','Send a photo for the staff section','',20], ['pension','month','Review private pension information','Decide within two months whether you want to cancel it.',25],
...
const taskResources = {
  ...
  key: `<details class="task-extra"><summary>Show key application details</summary><a href="https://dez5.uni-wuppertal.de/de/online-hilfe/ablauf-schluesselantrag/" target="_blank" rel="noopener noreferrer">Key application process ↗</a><p><strong>Rooms you need access to:</strong></p><ul class="resource-list room-list"><li>FME 02.03</li><li>FME 02.04</li><li>FME 02.06</li><li>FME 02.07</li><li>FME 02.08</li><li>FME 02.09</li><li>FME 02.13</li><li>FME AT.00.93</li></ul></details>`,
